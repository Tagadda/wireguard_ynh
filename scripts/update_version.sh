...
prepare_source --template="../conf/app.src.default" --destination="../conf/app.src"
prepare_source --template="../conf/wg-dashboard.ini.default" --destination="../conf/wg-dashboard.ini"
